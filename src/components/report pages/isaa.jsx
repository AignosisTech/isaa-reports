...
domain.</p> */}
  ...
  <p>
    Scores ({patientData.TOT_ISAA}) on ISAA suggest the presence of some autistic traits, although they do not meet the threshold for a conclusive diagnosis of autism spectrum disorder.
  </p>
)}        <br /><br />
        <center>
  <table border="4" style={{width: "50%", textAlign: "center", marginTop: "10px", border: "1px solid #d1d5db" , padding: "8px" }}>
    <tr>
      <th style={{ border: "1px solid #d1d5db", padding: "8px" }}>Score Range</th>
      <th style={{ border: "1px solid #d1d5db", padding: "8px" }}>Interpretation</th>
    </tr>
    <tr>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>Below 70</td>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>No Risk of Autism</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>70 - 106</td>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>Mild Risk of Autism</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>107 - 153</td>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>Moderate Risk of Autism</td>
    </tr>
    <tr>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>Above 153</td>
      <td style={{ border: "1px solid #d1d5db", padding: "8px" }}>Severe Risk of Autism</td>
    </tr>
  </table> 
</center>
<br /><br /><br />
